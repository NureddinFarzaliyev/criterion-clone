...
const HomeCC40 = () => {
  return (
    ...
    <section className='h-dvh snap-start relative home-section bg-light dark:bg-gray flex items-center justify-center cc40'>
      ...
      <span className='hidden lg:block absolute dark:text-white text-gray font-text bottom-96 text-xl font-bold cc40-span-bottom transition-all duration-900 opacity-0'>Click to Learn More</span>
