    ...
    <GeneralSection>
      <div className='flex items-center justify-center mt-10 flex-col'>
        <div className='text-center font-display'>
          ...
          <h1 className='mt-5 text-3xl md:text-5xl font-extrabold'>CONTACT US</h1>
        </div>
        ...
        <div className='font-text w-[90%] md:w-[70%] lg:w-[50%] mt-20 text-md md:text-xl flex flex-col gap-5'>
            ...
            <p className='text-sm italic'>Get info about new releases, sales, and our online publication, Current.</p>
            <div className='flex gap-3 mt-2 flex-col md:flex-row'>
                <input type="text" className='dark:bg-white/10 bg-gray/20 font-display text-sm px-4 py-3 shadow-2xl' placeholder='Enter Email Address' />
                <WhiteBtn textContent={"SIGN UP"} />
            </div>
        </div>
