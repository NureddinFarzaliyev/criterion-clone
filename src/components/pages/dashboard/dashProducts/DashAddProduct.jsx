...
const DashAddProduct = () => {
    ...
    return (
        <div>
            <p className='font-display uppercase mb-5 mt-20 opacity-60'><StaticLang en="add new product" az="Yeni məhsul əlavə et" /></p>
            ...
            <Dialog open={isOpen} onClose={() => setIsOpen(false)} transition
                ...
                <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
                    <DialogPanel className="md:w-[50vw] max-h-[80vh] overflow-y-scroll text-sm space-y-4 bg-gray text-white p-5">
                        <p className='font-display uppercase my-5 mb-10 opacity-60'><StaticLang en="add new product" az="Yeni məhsul əlavə et" /></p>
